        ...
        <div className="hero">
            ...
            <div className="introduction">
                <h1 className="hello f-size-p3 hero-anim">
                    <span style={{ color: "var(--yellow_3)" }}>Hi</span>, my
                    name is
                </h1>

                <h1 className="name f-size-h3 hero-anim">Beka arabidze</h1>
                ...
                <button className="check-more hero-anim">
                    <a
                        ...
                        href="/beka_arabidze_resume.pdf"
                        target="_blank"
                        rel="noreferrer"
                        download
                    >
                        <h1 className="f-weight-600 f-size-p3">resume</h1>
                    </a>
                </button>
            </div>
        </div>
